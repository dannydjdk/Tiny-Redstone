...
public class RenderHelper {
    ...
    public static void drawCube(PoseStack poseStack, VertexConsumer builder, TextureAtlasSprite sprite, int combinedLight, int color, float alpha) {
        drawCube(poseStack, builder, sprite, sprite, sprite, sprite, sprite, sprite, combinedLight, color, alpha, true);
    }
    ...
    public static void drawCube(PoseStack poseStack, VertexConsumer builder, TextureAtlasSprite sprite_top, TextureAtlasSprite sprite_front, TextureAtlasSprite sprite_right, TextureAtlasSprite sprite_back, TextureAtlasSprite sprite_left, TextureAtlasSprite sprite_bottom, int combinedLight, int color, float alpha) {
        drawCube(poseStack, builder, sprite_top, sprite_front, sprite_right, sprite_back, sprite_left, sprite_bottom, combinedLight, color, alpha, true);
    }

    public static void drawCube(PoseStack poseStack, VertexConsumer builder, TextureAtlasSprite sprite_top, TextureAtlasSprite sprite_front, TextureAtlasSprite sprite_right, TextureAtlasSprite sprite_back, TextureAtlasSprite sprite_left, TextureAtlasSprite sprite_bottom, int combinedLight, int color, float alpha, boolean applyDirectionalShading) {
    ...
    public static void drawRectangle(VertexConsumer builder, PoseStack matrixStack, float x1, float x2, float y1, float y2, TextureAtlasSprite sprite, int combinedLight, int color, float alpha) {
        drawRectangle(builder, matrixStack, x1, x2, y1, y2, sprite.getU0(), sprite.getU1(), sprite.getV0(), sprite.getV1(), combinedLight, color, alpha, true);
    }

    public static void drawRectangle(VertexConsumer builder, PoseStack matrixStack, float x1, float x2, float y1, float y2, TextureAtlasSprite sprite, int combinedLight, int color, float alpha, boolean applyDirectionalShading) {
        drawRectangle(builder, matrixStack, x1, x2, y1, y2, sprite.getU0(), sprite.getU1(), sprite.getV0(), sprite.getV1(), combinedLight, color, alpha, applyDirectionalShading);
    }
    ...
    public static void drawRectangle(VertexConsumer builder, PoseStack matrixStack, float x1, float x2, float y1, float y2, float u0, float u1, float v0, float v1, int combinedLight, int color, float alpha) {
        drawRectangle(builder, matrixStack, x1, x2, y1, y2, u0, u1, v0, v1, combinedLight, color, alpha, true);
    }

    public static void drawRectangle(VertexConsumer builder, PoseStack matrixStack, float x1, float x2, float y1, float y2, float u0, float u1, float v0, float v1, int combinedLight, int color, float alpha, boolean applyDirectionalShading) {
        ...
        // unless disabled (e.g., for GUI rendering where full brightness is desired)
        int finalColor = applyDirectionalShading
                ? applyShade(color, getShadeFromNormal(normal.x(), normal.y(), normal.z()))
                : color;

        Matrix4f matrix4f = matrixStack.last().pose();
        add(builder, matrix4f, x1, y1, 0, u0, v0, combinedLight, finalColor, alpha, normal.x(), normal.y(), normal.z());
        add(builder, matrix4f, x2, y1, 0, u1, v0, combinedLight, finalColor, alpha, normal.x(), normal.y(), normal.z());
        add(builder, matrix4f, x2, y2, 0, u1, v1, combinedLight, finalColor, alpha, normal.x(), normal.y(), normal.z());
        add(builder, matrix4f, x1, y2, 0, u0, v1, combinedLight, finalColor, alpha, normal.x(), normal.y(), normal.z());
    }
